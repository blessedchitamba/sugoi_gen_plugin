...
public class SugoiFrame {
    ...
    //constructor to initialize proxy.txt settings
    public SugoiFrame(){
        sugoi = initialize();
    }

    //function to initialize proxy.txt settings
    public Sugoi initialize() {
    ...
    public static void main(String[]args){
        SugoiFrame sf = new SugoiFrame();
        System.out.println("sugoi object created");
    }
}
