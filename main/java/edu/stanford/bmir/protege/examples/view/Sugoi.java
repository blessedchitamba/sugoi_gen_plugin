/*
Copyright notice
SUGOI-Gen copyright 2014-2017, Zubeida C. Khan
...
public class Sugoi extends javax.swing.JApplet {
   ...
   // String domainO;
    ...
    private int returnVal2;
    private int returnVal3;
    private int returnVal4;
    ...
    private File SourceFoFile;
    private File TargetFoFile;
    ...
    private boolean sourceFoFileBool = false;
    private boolean targetFoFileBool = false;
    ...
    private ArrayList badDomainEntities =new ArrayList();   
    ...
    private void initComponents() {
        ...
        fileChooser3.setFileFilter(new MyCustomFilter());
        fileChooser3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fileChooser3ActionPerformed(evt);
            }
        });

        fileChooser4.setFileFilter(new MyCustomFilter());
        fileChooser4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fileChooser4ActionPerformed(evt);
            }
        });
        ...
        jButton2.setText("Load source modular ontology");
        ...
        jCheckBox1.setText("<html>Uncheck if you do not want us to <br> keep a copy of your ontology</html>");
        ...
        jButton4.setText("Load source interchange module");
        ...
        jButton5.setText("Load target interchange module");
        ...
        jButton6.setText("Load mapping file");
        ...
        jLabel2.setText("<html>1. Load source modular ontology for interchange<br>2. Load source and target interchange ontologies<br> 3. Load mapping file <br>4. Click 'Interchange'</html>");

        jLabel20.setBackground(new java.awt.Color(255, 255, 255));
        jLabel20.setText("<html> Developer: <br> Zubeida C. Khan <br> Department of Computer Science <br> University of Cape Town, South Africa <br>and<br> Council for Scientific and Industrial <br> Research, Pretoria, South Africa <br> email:zkhan@csir.co.za </html>");
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanel6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 266, Short.MAX_VALUE))
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(27, 27, 27)
...
public ArrayList sourceDomainMetrics(){
   ...
   // generate log file for users explaining new axioms added to onto     
    public void generateLogFile(){ 
       ...
       // System.out.println("bad domain entities");
        for(int i=0;i< badaxiomList.size();i++){
            Set <OWLEntity> e = badaxiomList.get(i).getSignature();
                       for(OWLEntity ent: e){
                           if (sourceFoundationalOntology.containsEntityInSignature(ent.getIRI()) && !(ent.isBuiltIn()) ){
                               badDomainEntities.add(ent);
                           }
                           
                       }
            //System.out.println(badDomainEntitiesfreq.get(i)+" "+ Collections.frequency(badDomainEntities, badDomainEntitiesfreq.get(i)));
       
        }
        
        tempHolder = new LinkedHashSet(badDomainEntities); 
        //badDomainEntities.clear();
        ArrayList badDomainEntitiesfreq = new ArrayList();
        badDomainEntitiesfreq.addAll(tempHolder);
        tempHolder.clear();
        
       
        
       // System.out.println("end bad domain entities");
    ...
    //  int doment= (numClasses+ numOp+numDp+indiv) - (numClasses2 + numOp2 +numDp2 +indiv2);
      ...
      bwrite.write("Source foundational ontology entities and frequencies \n\n ");
       for(int i=0;i< badDomainEntitiesfreq.size();i++){
            bwrite.write(badDomainEntitiesfreq.get(i)+": "+Collections.frequency(badDomainEntities, badDomainEntitiesfreq.get(i))+"\n");
            System.out.println(badDomainEntitiesfreq.get(i)+": "+Collections.frequency(badDomainEntities, badDomainEntitiesfreq.get(i)));
      ...
      bwrite.write("Ontology Interchangeability measure = Axioms referencing domain entity and target foundational ontology entity from target ontology/ Axioms referencing domain entity and foundational ontology entity from target ontology \n");
      bwrite.write("Axioms referencing domain entity and target foundational ontology from target ontology: "+good+"\n");
      bwrite.write("Axioms referencing domain entity and source foundational ontology from target ontology: "+bad+"\n");
      bwrite.write("Axioms referencing domain entity and foundational ontology from target ontology: "+tot+"\n");
      bwrite.write("Ontology interchangeability measure = ("+good+" / "+tot+ ") x 100 = "+interchangeability +"%\n\n");
    
      
      bwrite.write("Target Ontology: Axioms that link domain entities to foundational ontology entities: \n\n");
                ...
                walker) {
                    ...
                    public Object visit(OWLAnnotationProperty annoToWalk) {
                        ...
                        if( (!(sourceFoundationalOntology.containsAnnotationPropertyInSignature(annoToWalk.getIRI()))) &&
                            ...
                            OWLAxiom toParse = getCurrentAxiom();
                            //System.out.println("default ann "+toParse);
                            String newstring="";
                            if(!(toParse == null) ){
                            //if subclass or equiv class or disj cl or disj union
                            ...
                            for (OWLClass myclass : myclasses) {
                                ...
                                if (domainSourceOntology.containsClassInSignature(classiri) && (!(targetFoundationalOntology.containsClassInSignature(classiri)))) {
                                    ...
                                    if (!(equiclasses.isEmpty())) {
                                        ...
                                        //zckadd1
                                         if (myaxiom.isOfType(AxiomType.SUBCLASS_OF)) {
                                            //toAdd = factory.getOWLDataPropertyDomainAxiom(mydpprop, equiclass);
                                        //System.out.println("DPV "+myaxiom);
                                             toAdd = factory.getOWLDataPropertyDomainAxiom(mydpprop, equiclass);
                                         }
                                         //zckadd1
                    ...
                    public Object visit(OWLClass classToWalk) {
                        ...
                        if( (!(sourceFoundationalOntology.containsClassInSignature(classToWalk.getIRI()))) &&
                            ...
                            if( (toParse.isOfType(AxiomType.SUBCLASS_OF)) || (toParse.isOfType(AxiomType.EQUIVALENT_CLASSES))
                                ...
                                //if(classToWalk.toString().startsWith("<http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#abstract-region")){
                                  //  System.out.println("TP "+toParse);
                              // }
                                newstring="";
                                newstring =toParse.toString();
                            ...
                            if (sourceFoundationalOntology.containsClassInSignature(tempiri) && classToWalk.getSuperClasses(sourceFoundationalOntology).isEmpty()) {
                                ...
                                if (((!(superclasses.isEmpty())) && (subBool == false)) || (superclasses.isEmpty())) {
                                    ...
                                    if (!(mapClasses.isEmpty())) {
                                        ...
                                        System.out.println("on the fly "+tempax);
                                          
                                                
                                        mapClasses.clear();
                                        superclasses.clear();
                                        strangeSet.clear();
                                     //  long cur2 = System.nanoTime(); //records the time when start executing
                       // double elapsedTime = cur2-cur;
...
System.out.println("im here");
        try {
            ...
            System.out.println("Loaded domain ontology: " + domainSourceOntology);
     ...
     // domainO = domainSourceFile.getName().substring(0, domainSourceFile.getName().length() - 4);
    ...
    private void loadSourceFoOntology() {
      ...
      //  managerDomainSource = OWLManager.createOWLOntologyManager();
       ...
       // managerMapper = OWLManager.createOWLOntologyManager();
        ...
        try {
            sourceFoundationalOntology = managerFoundationalSource.loadOntologyFromOntologyDocument(SourceFoFile);
            //tempf = SourceFoFile.getName().substring(0, SourceFoFile.getName().length() - 4);
            System.out.println("Loaded source fo ontology: " + sourceFoundationalOntology);
           // jTextPane2Text = jTextPane2Text + "Loaded ontology file path: " + domainSourceFile.getAbsolutePath().toString() + "\n\n";
            sourceFoFileBool = true;
...
*/
            ...
            errorText = errorText + "Error: The source fo ontology is not a valid OWL file.\n\n";
            jTextPane2.setText(loadText + "\n" + errorText);
            sourceFoFileBool = false;
        }
        jProgressBar1.setValue(3);
       jProgressBar1.update(jProgressBar1.getGraphics());
        jTextPane2.update(jTextPane2.getGraphics());
     ...
     private void loadTargetFoOntologyAndDomainTargetOntology() {
        jProgressBar1.setVisible(true);
        jTextPane2Text = jTextPane2.getText()+"\n\n"+"Processing....." + "\n \n";
        jTextPane2.setText(jTextPane2Text);
        jTextPane2.update(jTextPane2.getGraphics());
      ...
      //  managerDomainSource = OWLManager.createOWLOntologyManager();
       ...
       // managerMapper = OWLManager.createOWLOntologyManager();
        ...
        try {
            targetFoundationalOntology = managerFoundationalTarget.loadOntologyFromOntologyDocument(TargetFoFile);
            //tempf = TargetFoFile.getName().substring(0, TargetFoFile.getName().length() - 4);
            System.out.println("Loaded target ontology: " + targetFoundationalOntology);
           // jTextPane2Text = jTextPane2Text + "Loaded ontology file path: " + domainSourceFile.getAbsolutePath().toString() + "\n\n";
            targetFoFileBool = true;
            ...
            domainTargetOntology = managerDomainTarget.loadOntologyFromOntologyDocument(targetIRI);
*/
            targetIRI = managerFoundationalTarget.getOntologyDocumentIRI(targetFoundationalOntology);
        domainTargetOntology = managerDomainTarget.loadOntologyFromOntologyDocument(targetIRI);
        targetFO= TargetFoFile.getName().substring(0, TargetFoFile.getName().length() - 4);
        } catch (OWLOntologyCreationException e) {
            errorText = errorText + "Error: The target fo ontology is not a valid OWL file.\n\n";
            jTextPane2.setText(loadText + "\n" + errorText);
            targetFoFileBool = false;
        }
        jProgressBar1.setValue(3);
       jProgressBar1.update(jProgressBar1.getGraphics());
        jTextPane2.update(jTextPane2.getGraphics());
     ...
     private void loadMapOntology() {
      ...
      //  managerDomainSource = OWLManager.createOWLOntologyManager();
       ...
       // managerMapper = OWLManager.createOWLOntologyManager();
        ...
        try {
            mapOntology = managerMapper.loadOntologyFromOntologyDocument(mapFile);
            //tempf =mapFile.getName().substring(0, mapFile.getName().length() - 4);
            System.out.println("Loaded map ontology: " + mapOntology);
           // jTextPane2Text = jTextPane2Text + "Loaded ontology file path: " + domainSourceFile.getAbsolutePath().toString() + "\n\n";
            mapFileBool = true;
...
*/
            ...
            errorText = errorText + "Error: The map ontology is not a valid OWL file.\n\n";
            jTextPane2.setText(loadText + "\n" + errorText);
            mapFileBool = false;
        }
        jProgressBar1.setValue(3);
      ...
      /*  String [] ontologies = jList1.getSelectedValue().toString().split(" to ");        
        ...
        */
        ...
        if (sourceFileBool == true) {
            ...
            targetIRI=managerFoundationalTarget.getOntologyDocumentIRI(targetFoundationalOntology);
            sourceIRI = managerFoundationalSource.getOntologyDocumentIRI(sourceFoundationalOntology);
            mapIRI = managerMapper.getOntologyDocumentIRI(mapOntology);
 ...
 domainTargetOntology = managerDomainTarget.loadOntologyFromOntologyDocument(targetIRI);
    ...
    private void loadAllMethods() {
        ...
        try {
           ...
           // emailFiles();
            ...
            System.out.println("Error walking " + e.getCause()+ " "+e.getLocalizedMessage());
            e.printStackTrace();
        }
    ...
    private void interchange() {    
        ...
        loadSourceFoOntology();
        loadTargetFoOntologyAndDomainTargetOntology();
        loadMapOntology();
    ...
    private void fileChooserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fileChooserActionPerformed
        ...
        if (sourceFileBool == false) {
            if (returnVal == fileChooser.APPROVE_OPTION) {
                ...
                newText = "Source ontology to be interchanged: " + domainSourceFile+"\n" ;
...
//        countDownProgressBar();
    ...
    badDomainEntities =new ArrayList();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        input = new JLabel();
        returnVal2 = fileChooser2.showOpenDialog(this);
        
        jButton4.setEnabled(false);
        jButton4.update(jButton4.getGraphics());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        input = new JLabel();
        returnVal3 = fileChooser3.showOpenDialog(this);
        
         jButton5.setEnabled(false);
        jButton5.update(jButton5.getGraphics());
    ...
    private void fileChooser2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fileChooser2ActionPerformed
        ...
        if (sourceFoFileBool == false) {
            if (returnVal2 == fileChooser2.APPROVE_OPTION) {
                SourceFoFile = fileChooser2.getSelectedFile();
                newText = "Source modular ontology: " + SourceFoFile+"\n";
    ...
    private void fileChooser3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fileChooser3ActionPerformed
        // TODO add your handling code here:
        
         if (targetFoFileBool == false) {
            if (returnVal3 == fileChooser3.APPROVE_OPTION) {
                TargetFoFile = fileChooser3.getSelectedFile();
                newText = "Target modular ontology: " + TargetFoFile+"\n";
    ...
    }//GEN-LAST:event_fileChooser3ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        
         input = new JLabel();
        returnVal4 = fileChooser4.showOpenDialog(this);
        
        jButton6.setEnabled(false);
        jButton6.update(jButton6.getGraphics());
    }//GEN-LAST:event_jButton6ActionPerformed

    private void fileChooser4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fileChooser4ActionPerformed
        // TODO add your handling code here:
        
        if (mapFileBool == false) {
            if (returnVal4 == fileChooser4.APPROVE_OPTION) {
                mapFile = fileChooser4.getSelectedFile();
                newText = "Mapping ontology: " + mapFile+"\n";
    ...
    }//GEN-LAST:event_fileChooser4ActionPerformed
